...
At the end of the step one should have 300 labeled images in the `Data` sub folder.  
A [pre labeled file are available to download](https://drive.google.com/file/d/1ocqIxXP--q0KXIylTKQIqTwQgw3ZsiX3).

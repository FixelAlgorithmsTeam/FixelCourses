...
### Signal Processing
 ...
 - [MIMII - A sound dataset for malfunctioning industrial machine investigation and inspection (Anomaly Detection)](https://github.com/MIMII-hitachi/mimii_baseline).
 - Audio Classification: [GTZAN Dataset - Music Genre Classification](https://www.kaggle.com/datasets/andradaolteanu/gtzan-dataset-music-genre-classification), [ESC-50: Dataset for Environmental Sound Classification](https://github.com/karolpiczak/esc-50), [UrbanSound8k dataset](https://urbansounddataset.weebly.com/urbansound8k.html). See [Rethinking CNN Models for Audio Classification](https://arxiv.org/abs/2007.11154) for reference performance and ideas on augmentations.

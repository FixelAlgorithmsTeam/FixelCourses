...
There are _loss_ friendly variants of the _IoU_. See [TorchVision's `complete_box_iou_loss`](https://pytorch.org/vision/stable/generated/torchvision.ops.complete_box_iou_loss.html).
...
:::{.incremental} 
 ...
 - There are common libraries for training: [Facebook Detectron](https://github.com/facebookresearch/detectron2), [Ultralytics](https://github.com/ultralytics/ultralytics), [Lightning Bolts](https://github.com/Lightning-Universe/lightning-bolts), [RF DETR](https://github.com/roboflow/rf-detr).
:::
...
:::{.incremental} 
 ...
 - The current most common model is [`YOLOv26`](https://github.com/ultralytics/ultralytics). Mainly due the popular framework built by `Ultralytics`.
...
Use known models until the community marks a newer version as **consensus** (Currently `YOLOv11`).
:::
...
:::{.incremental style="font-size: 80%;"} 
 - Choose the Model  
   ...
   Currently stick with `YOLOv11` (Or RF DETR).
 ...
 * Download the Workshop files from [Fixel Courses](https://github.com/FixelAlgorithmsTeam/FixelCourses).  
   The files are located in `AIProgram/2025_09/WorkShop001`.
 * Create a `conda` environment based on [`EnvConda.yml`](https://github.com/FixelAlgorithmsTeam/FixelCourses/blob/master/AIProgram/2024_12/WorkShop002/EnvObjectDetection.yml).
:::
...
animation:
  ...
  - - element: "#detection-tile"
      ...
      modifier: attr
      parameters:
        - transform: "translate(960 440)"
  - - element: "#detection-tile"
      duration: 700
      delay: 0
      modifier: attr
      parameters:
        - transform: "translate(1280 440)"
  - - element: "#detection-tile"
      duration: 300
      delay: 0
      modifier: attr

...
:::{.incremental} 
 ...
 - Hence, conceptually, in the classic method was reintroduced.
 - The concept of _Trnasposed Convolution_ was introduced in [Fully Convolutional Networks for Semantic Segmentation](https://arxiv.org/abs/1411.4038).
:::

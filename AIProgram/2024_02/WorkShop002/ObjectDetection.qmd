...
:::{.incremental style="font-size: 80%;"} 
 ...
 - Labelling  
   Apply labelling on the data if required.
...
# Test Case - Ball and Players Detection

## The Task {.unlisted}

:::{.incremental}
 * Given an HD Image (`1920x1080`) of a _Football_ (Soccer) game:
    * Detect the Ball.
    * Detect the Players.
...
Create a `conda` environment based on [`EnvObjectDetection.yml`]().
...
:::{.incremental}
 * The Training Set: 250 Images.
 * The Test Set: 50 Images.
:::
 ...
 * [Grid Size](https://github.com/ultralytics/ultralytics/issues/8863): `[80x80, 40x40, 20x20]`. See [Defaults YOLOv8 Grid Size](https://stackoverflow.com/questions/75904407)
 * Number of Parameters: `3.2e6`.
:::

## Labeling {.unlisted}

## Generating Data {.unlisted}
